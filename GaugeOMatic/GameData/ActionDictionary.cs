...
public partial class ActionData
{
    public static readonly Dictionary<uint, ActionRef> Actions = new()
    {
        ...
        { 7531,  new(7531,  JobData.Job.None, "Rampart",                90,  1, Tank                            ) },
        { 7533,  new(7533,  JobData.Job.None, "Provoke",                30,  1, Tank                            ) },
        { 7535,  new(7535,  JobData.Job.None, "Reprisal",               60,  1, Tank                            ) },
        { 7537,  new(7537,  JobData.Job.None, "Shirk",                  120, 1, Tank                            ) },
        { 7538,  new(7538,  JobData.Job.None, "Interject",              30,  1, Tank                            ) },
        { 7540,  new(7540,  JobData.Job.None, "Low Blow",               25,  1, Tank                            ) },
        { 7541,  new(7541,  JobData.Job.None, "Second Wind",            120, 1, Melee | Ranged             ) },
        { 7542,  new(7542,  JobData.Job.None, "Bloodbath",              90,  1, Melee                           ) },
        { 7546,  new(7546,  JobData.Job.None, "True North",             45,  2, Melee                           ) },
        { 7548,  new(7548,  JobData.Job.None, "Arm's Length",           120, 1, Melee | Ranged | Tank ) },
        { 7549,  new(7549,  JobData.Job.None, "Feint",                  90,  1, Melee                           ) },
        { 7551,  new(7551,  JobData.Job.None, "Head Graze",             30,  1, Ranged                          ) },
        { 7553,  new(7553,  JobData.Job.None, "Foot Graze",             30,  1, Ranged                          ) },
        { 7554,  new(7554,  JobData.Job.None, "Leg Graze",              30,  1, Ranged                          ) },
        { 7559,  new(7559,  JobData.Job.None, "Surecast",               120, 1, Caster | Healer            ) },
        { 7560,  new(7560,  JobData.Job.None, "Addle",                  90,  1, Caster                          ) },
        { 7561,  new(7561,  JobData.Job.None, "Swiftcast",              60,  1, Caster | Healer            ) },
        { 7562,  new(7562,  JobData.Job.None, "Lucid Dreaming",         60,  1, Caster | Healer            ) },
        { 7571,  new(7571,  JobData.Job.None, "Rescue",                 120, 1, Healer                          ) },
        { 7863,  new(7863,  JobData.Job.None, "Leg Sweep",              40,  1, Melee                           ) },
        ...
        { 3566,  new(3566,  NIN,  "Dream Within a Dream",   60     ) },
        { 7403,  new(7403,  NIN,  "Ten Chi Jin",            120    ) },
        { 16489, new(16489, NIN,  "Meisui",                 120    ) },
        { 16493, new(16493, NIN,  "Bunshin",                90     ) },

        { 7492,  new(7492,  SAM,  "Hissatsu: Gyoten",       10     ) },
        { 7493,  new(7493,  SAM,  "Hissatsu: Yaten",        10     ) },
        { 7496,  new(7496,  SAM,  "Hissatsu: Guren",        120    ) },
        { 7497,  new(7497,  SAM,  "Meditate",               60     ) },
        { 7498,  new(7498,  SAM,  "Third Eye",              15     ) },
        { 7499,  new(7499,  SAM,  "Meikyo Shisui",          55,  2 ) },
        { 16481, new(16481, SAM,  "Hissatsu: Senei",        120    ) },
        { 16482, new(16482, SAM,  "Ikishoten",              120    ) },
        { 16483, new(16483, SAM,  "Tsubame-gaeshi",         60,  2 ) },
        { 16487, new(16487, SAM,  "Shoha",                  15     ) },
        { 25779, new(25779, SAM,  "Shoha II",               15     ) },
        ...
        { 24394, new(24394, RPR,  "Enshroud",               15     ) },
        { 24393, new(24393, RPR,  "Gluttony",               60     ) },
        ...
        { 25785, new(25785, BRD,  "Radiant Finale",         110    ) },

        { 2872,  new(2872,  MCH,  "Hot Shot",               40     ) },
        ...
        { 7415,  new(7415,  MCH,  "Rook Overdrive",         15     ) },
        { 7418,  new(7418,  MCH,  "Flamethrower",           60     ) },
        { 16498, new(16498, MCH,  "Drill",                  20     ) },
        { 16499, new(16499, MCH,  "Bioblaster",             20     ) },
        { 16500, new(16500, MCH,  "Air Anchor",             40     ) },
        { 16502, new(16502, MCH,  "Queen Overdrive",        15     ) },
        { 16889, new(16889, MCH,  "Tactician",              120    ) },
        { 17209, new(17209, MCH,  "Hypercharge",            10     ) },
        ...
        { 25796, new(25796, BLM,  "Amplifier",              120    ) },

        { 3581,  new(3581,  SMN,  "Dreadwyrm Trance",       60     ) },
        { 7427,  new(7427,  SMN,  "Summon Bahamut",         60     ) },
        ...
        { 16527, new(16527, RDM,  "Engagement",             35,  2 ) },
        ...
        { 29,    new(29,    PLD,  "Spirits Within",         30     ) },
        ...
        { 7389,  new(7389,  WAR,  "Inner Release",          60     ) },
        { 16464, new(16464, WAR,  "Nascent Flash",          25     ) },
        { 25751, new(25751, WAR,  "Bloodwhetting",          25     ) },
        ...
        { 25758, new(25758, GNB,  "Heart of Corundum",      25     ) },
        { 16165, new(16165, GNB,  "Blasting Zone",          30     ) },
        { 16164, new(16164, GNB,  "Bloodfest",              120    ) },
        { 16161, new(16161, GNB,  "Heart of Stone",         25     ) },
        ...
        { 16144, new(16144, GNB,  "Danger Zone",            30     ) },
        ...
        { 24289, new(24289, SGE,  "Phlegma",                40,  2 ) },
        { 24288, new(24288, SGE,  "Physis",                 60     ) },
