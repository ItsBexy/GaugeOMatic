...
public abstract partial class StatusData
{
    ...
    { 1180, new(1180, MNK, "Earth's Resolve",          Self,   1, 15 ) },
    { 1181, new(1181, MNK, "Riddle of Fire",           Self,   1, 20 ) },
    { 1182, new(1182, MNK, "Meditative Brotherhood",   Self,   1, 20 ) },
    ...
    { 3841, new(3841, MNK,"Earth's Rumination",        Self,   1, 30 ) },

    { 116,  new(116,  DRG, "Life Surge",               Self,   1, 5  ) },
    { 786,  new(786,  DRG, "Battle Litany",            Self,   1, 20 ) },
    ...
    { 3844, new(3844, DRG, "Nastrond Ready",           Self,   3, 20 ) },
    { 3845, new(3845, DRG, "Dragon's Flight",          Self,   1, 30 ) },
    { 3846, new(3846, DRG, "Starcross REady",          Self,   1, 20 ) },

    { 638,  new(638,  NIN, "Mug",                      Target, 1, 20,  seeAlso: new() { 3848 } ) { HideFromDropdown = true } },
    { 3254, new(3254, NIN, "Trick Attack",             Target, 1, 15,  seeAlso: new() { 3906 } ) { HideFromDropdown = true } },
    ...
    { 3848, new(3848, NIN, "Shadow Walker",            Self,   1, 20 ) },
    { 3849, new(3849, NIN, "Dokumori",                 Target, 1, 20,  seeAlso: new() { 638 }) },
    { 3850, new(3850, NIN, "Higi",                     Self,   1, 30 ) },
    { 3851, new(3851, NIN, "Tenri Jindo Ready",        Self,   1, 30 ) },
    { 3906, new(3906, NIN, "Kunai's Bane",             Target, 1, 15,  seeAlso: new() { 3254 } ) },

    { 1232, new(1232, SAM, "Third Eye",                Self,   1, 4,   seeAlso: new(3853)) {HideFromDropdown = true} },
    ...
    { 3852, new(3852, SAM, "Tsubame-gaeshi Ready",     Self,   1, 30 ) },
    { 3853, new(3853, SAM, "Tengetsu",                 Self,   1, 4 ,  seeAlso: new(1232)) },
    { 3854, new(3854, SAM, "Tengetsu's Foresight",     Self,   1, 8  ) },
    ...
    { 2972, new(2972, RPR, "Bloodsown Circle",         Self,   1, 6 ,  seeAlso: new() { 2601 }) },
    { 3857, new(3857, RPR, "Oblatio",                  Self,   1, 30) },
    { 3858, new(3858, RPR, "Executioner",              Self,   2, 30) },
    { 3859, new(3859, RPR, "Perfectio Occulta",        Self,   1, 30) },
    { 3860, new(3860, RPR, "Perfectio Parata",         Self,   1, 30) },
    { 3905, new(3905, RPR, "Ideal Host",               Self,   1, 30) },

    { 3645, new(3645, VPR, "Flankstung Venom",         Self,   1, 60 ) },
    { 3646, new(3646, VPR, "Flanksbane Venom",         Self,   1, 60 ) },
    { 3647, new(3647, VPR, "Hindstung Venom",          Self,   1, 60 ) },
    { 3648, new(3648, VPR, "Hindsbane Venom",          Self,   1, 60 ) },
    { 3649, new(3649, VPR, "Grimhunter's Venom",       Self,   1, 40 ) },
    { 3650, new(3650, VPR, "Grimskin's Venom",         Self,   1, 40 ) },
    { 3657, new(3657, VPR, "Hunter's Venom",           Self,   1, 30 ) },
    { 3658, new(3658, VPR, "Swiftskin's Venom",        Self,   1, 30 ) },
    { 3659, new(3659, VPR, "Fellhunter's Venom",       Self,   1, 30 ) },
    { 3660, new(3660, VPR, "Fellskin's Venom",         Self,   1, 30 ) },
    { 3672, new(3672, VPR, "Honed Steel",              Self,   1, 60 ) },
    { 3668, new(3668, VPR, "Hunter's Instinct",        Self,   1, 40 ) },
    { 3669, new(3669, VPR, "Swiftscaled",              Self,   1, 40 ) },
    { 3671, new(3671, VPR, "Ready to Reawaken",        Self,   1, 30 ) },
    { 3670, new(3670, VPR, "Reawakened",               Self,   1, 30 ) },
    ...
    { 3863, new(3863, BRD, "Radiant Encore Ready",     Self,   1, 30 ) },
    ...
    { 3864, new(3864, MCH, "Hypercharged",             Self,   1, 30 ) },
    { 3865, new(3865, MCH, "Excavator Ready",          Self,   1, 30 ) },
    { 3866, new(3866, MCH, "Full Metal Machinist",     Self,   1, 30 ) },
    ...
    { 3867, new(3867, DNC, "Last Dance Ready",         Self,   1, 30 ) },
    { 3868, new(3868, DNC, "Finishing Move Ready",     Self,   1, 30 ) },
    { 3869, new(3869, DNC, "Dance of the Dawn Ready",  Self,   1, 30 ) },
    ...
    { 3873, new(3873, SMN, "Ruby's Glimmer",           Self,   1, 30 ) },
    { 3874, new(3874, SMN, "Refulgent Lux",            Self,   1, 30 ) },
    ...
    { 3875, new(3875, RDM, "Magicked Swordplay",       Self,   3, 15 ) },
    { 3876, new(3876, RDM, "Thorned Flourish",         Self,   1, 30 ) },
    { 3877, new(3877, RDM, "Grand Impact Ready",       Self,   1, 30 ) },
    { 3878, new(3878, RDM, "Prefulgence Ready",        Self,   1, 30 ) },

    { 3674, new(3674, PCT, "Subtractive Palette",      Self,   3, 0  ) },
    { 3675, new(3675, PCT, "Aetherhues",               Self,   1, 30 ) },
    { 3676, new(3676, PCT, "Aetherhues II",            Self,   1, 30 ) },
    { 3679, new(3679, PCT, "Rainbow Bright",           Self,   1, 30 ) },
    { 3680, new(3680, PCT, "Hammer Time",              Self,   3, 30 ) },
    { 3681, new(3681, PCT, "Starstruck",               Self,   1, 20 ) },
    { 3684, new(3684, PCT, "Smudge",                   Self,   1, 5  ) },
    { 3685, new(3685, PCT, "Starry Muse",              Self,   1, 20 ) },
    { 3686, new(3686, PCT, "Tempera Coat",             Self,   1, 10 ) },
    { 3687, new(3687, PCT, "Tempera Grassa",           Self,   1, 10 ) },
    { 3688, new(3688, PCT, "Hyperphantasia",           Self,   5, 30 ) },
    { 3689, new(3689, PCT, "Inspiration",              Self,   1, 0  ) },
    { 3690, new(3690, PCT, "Subtractive Spectrum",     Self,   1, 30 ) },
    { 3691, new(3691, PCT, "Monochrome Tones",         Self,   1, 0  ) },
    ...
    { 3827, new(3827, PLD,"Supplication Ready",        Self,   1, 30 ) },
    { 3828, new(3828, PLD,"Sepulchre Ready",           Self,   1, 30 ) },
    { 3829, new(3829, PLD,"Guardian",                  Self,   1, 15 ) },
    { 3831, new(3831, PLD,"Blade of Honor Ready",      Self,   1, 30 ) },
    { 3847, new(3847, PLD,"Goring Blade Ready",        Self,   1, 30 ) },
    ...
    { 3832, new(3832, WAR, "Damnation",                Self,   1, 15 ) },
    { 3833, new(3833, WAR, "Burgeoning Fury",          Self,   3, 30 ) },
    ...
    { 811,  new(811,  DRK, "Walking Dead",             Self,   1, 10 ) },
    { 1178, new(1178, DRK, "Blackest Night",           Self,   1, 7 ) },
    { 1894, new(1894, DRK, "Dark Missionary",          Self,   1, 15 ) },
    { 1972, new(1972, DRK, "Delirium",                 Self,   3, 15,  seeAlso: new() { 3836 } ) },
    { 2682, new(2682, DRK, "Oblation",                 Self,   1, 10 ) },
    { 3255, new(3255, DRK, "Undead Rebirth",           Self,   1, 10 ) },
    { 3835, new(3835, DRK, "Shadowed Vigil",           Self,   1, 15 ) },
    { 3837, new(3837, DRK, "Scorn",                    Self,   1, 30 ) },
    { 3902, new(3902, DRK, "Vigilant",                 Self,   1, 20 ) },

    { 1831, new(1831, GNB, "No Mercy",                 Self,   1, 20 ) },
    { 1832, new(1832, GNB, "Camouflage",               Self,   1, 20 ) },
    { 1833, new(1833, GNB, "Royal Guard",              Self,   1, 0 ) },
    { 1834, new(1834, GNB, "Nebula",                   Self,   1, 15,  seeAlso: new() { 3838 } ) },
    ...
    { 3839, new(3839, GNB, "Ready to Raze",            Self,   1, 10 ) },
    { 3840, new(3840, GNB, "Ready to Reign",           Self,   1, 30 ) },
    { 3886, new(3886, GNB, "Ready to Break",           Self,   1, 30 ) },
    ...
    { 3879, new(3879, WHM, "Sacred Sight",             Self,   3, 30 ) },
    { 3880, new(3880, WHM, "Medica III",               Self,   1, 15,  seeAlso: new() { 150 } ) },
    { 3903, new(3903, WHM, "Divine Caress",            Self,   1, 10) },
    { 3904, new(3904, WHM, "Divine Aura",              Self,   1, 15 ) },
    ...
    { 3882, new(3882, SCH, "Impact Imminent",          Self,   1, 30 ) },
    { 3883, new(3883, SCH, "Baneful Impaction",        Self,   1, 15 ) },
    { 3884, new(3884, SCH, "Seraphism",                Self,   1, 20,  seeAlso: new() { 3885 } ) },

    { 841,  new(841,  AST, "Lightspeed",               Self,   1, 15,  seeAlso: new() { 1403 } ) },
    ...
    { 3887, new(3887, AST, "The Balance",              Self,   1, 15 ) },
    { 3890, new(3890, AST, "The Bole",                 Self,   1, 15 ) },
    { 3888, new(3888, AST, "The Arrow",                Self,   1, 15 ) },
    { 3889, new(3889, AST, "The Spear",                Self,   1, 15 ) },
    { 3891, new(3891, AST, "The Ewer",                 Self,   1, 15 ) },
    { 3892, new(3892, AST, "The Spire",                Self,   1, 30 ) },
    { 3893, new(3893, AST, "Divining",                 Self,   1, 30 ) },
    { 3894, new(3894, AST, "Helios Conjunction",       Self,   1, 30,  seeAlso: new() { 836 } ) },
    { 3895, new(3895, AST, "Suntouched",               Self,   1, 30 ) },
    { 3896, new(3896, AST, "Sun Sign",                 Self,   1, 15 ) },
