...
public unsafe partial class CustomNodeManager
{
    public partial class CustomNode
    {
        ...
        public CustomNode SetPartId(ushort id)
        {
            ...
            if (Node->Type == NodeType.NineGrid) Node->GetAsAtkNineGridNode()->PartID = id;
            return this;
        }
        ...
        {
            if (Node->Type == NodeType.Image) Node->GetAsAtkImageNode()->PartsList = partsList;
            else if (Node->Type == NodeType.NineGrid) Node->GetAsAtkNineGridNode()->PartsList = partsList;
